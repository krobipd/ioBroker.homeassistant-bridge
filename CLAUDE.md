...
2. **Shared UUID** (seit v0.10.0) — eine UUID in main.ts, an WebServer + mDNS durchgereicht
...
| Version | Highlights |
|---------|------------|
| 0.10.0 | Shared UUID (WebServer + mDNS konsistent), cleanup redundante Scripts |
